              ...
              <div className="md:col-span-2 space-y-6 md:space-y-8">
                ...
                <Card>
                  <h3 className="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
                    <ShieldCheck size={20} className="text-blue-500" /> Verification History
                  </h3>
                  ...
                  <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[11px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                      <div className="flex items-center justify-center w-6 h-6 rounded-full border border-white bg-emerald-500 text-white shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 mx-[-6px] md:mx-0">
                        <Check size={12} />
                      </div>
                      <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] p-4 rounded-xl bg-slate-50 border border-slate-100 shadow-sm ml-6 md:ml-0">
                        <h4 className="font-bold text-slate-800">Digital ID Minted</h4>
                        <p className="text-sm text-slate-500 mt-1">Identity secured on blockchain</p>
                        <time className="text-xs font-semibold text-emerald-600 mt-2 block">Today, 10:00 AM</time>
                      </div>
                    </div>
                    
                    {/* Timeline Item 2 */}
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group opacity-80">
                      ...
                      <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] p-4 rounded-xl bg-slate-50 border border-slate-100 shadow-sm ml-6 md:ml-0">
                        <h4 className="font-bold text-slate-800">KYC Documents Approved</h4>
                        <p className="text-sm text-slate-500 mt-1">Passport verification successful</p>
                        <time className="text-xs font-semibold text-blue-600 mt-2 block">Today, 09:45 AM</time>
                      </div>
                    </div>
                  </div>
